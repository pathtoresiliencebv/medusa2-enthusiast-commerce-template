                  ...
                  {values.map((value) => {
                    ...
                    return (
                      <button
                        ...
                        className={clsx(
                          "border-[#dedbe9] rounded-full border text-small-regular min-h-10 px-3 flex items-center transition-colors duration-150",
                          {
                            "border-[#6554c0] bg-[#6554c0] text-white":
                              isSelected,
                            "bg-white text-[#69667a] hover:border-[#6554c0] hover:text-[#15162a]":
                              !isSelected,
                          }
                        )}
